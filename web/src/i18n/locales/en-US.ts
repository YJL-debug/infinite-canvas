export default {
    ...
    canvas: {
        ...
        batchEdit: { action: "Batch edit", primary: "Primary image only", scope: "Entire group ({{count}})", hint: "Apply the same instruction to {{count}} source images, producing one result each. The original group is kept.", generate: "Edit {{count}} images", source: "Source image", sourceNumber: "Image {{index}} in the original group", noImages: "This group has no completed images to edit.", promptRequired: "Enter an edit instruction." },
        randomImage: { label: "Random character / style", hint: "Text-to-image only. Each image gets its own character and style suggestions; explicit prompt details take priority. View the sampled settings in the result information.", textOnly: "Random character / style is for text-to-image. Turn it off or remove reference images.", originalPrompt: "Original prompt", settings: "Sampled suggestions" },
