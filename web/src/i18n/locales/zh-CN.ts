export default {
    ...
    canvas: {
        ...
        batchEdit: { action: "批量改图", primary: "只改主图", scope: "修改整组（{{count}} 张）", hint: "同一句要求分别修改 {{count}} 张原图，每张生成 1 张新图，原组保留。", generate: "批量修改 {{count}} 张", source: "对应原图", sourceNumber: "原组第 {{index}} 张", noImages: "这组没有可修改的已完成图片。", promptRequired: "请填写批量修改要求。" },
        randomImage: { label: "随机人物 / 画风", hint: "仅用于文生图。每张图独立抽取人物和画风，原提示词已指定的内容优先。结果信息中可查看本次设定。", textOnly: "随机人物 / 画风仅用于文生图，请关闭随机模式或移除参考图。", originalPrompt: "原始提示词", settings: "本次随机候选" },
